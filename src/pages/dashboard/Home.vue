    ...
    <div class="lg:px-6 -mt-18 grid lg:grid-cols-3 px-4 lg:gap-6 gap-3">
      ...
      >
          ...
          <div class="flex items-center justify-between">
            <div class="flex flex-col">
              ...
              <span class="text-sm text-black-rgba-100 font-semimedium"
                >Compared to N0.0 last month</span
              >
            </div>
            <div
        ...
        <div class="flex items-center">
          ...
          >
            <span class="font-medium text-sm text-[#003b3d]"> Manage wallet </span>
            <span>
              <IArrowRightTail />
            </span>
          </router-link>
      ...
      >
        ...
        <div>
          <button
            @click="router.push({ path: '/dashboard/payroll/add-new' })"
            class="flex items-center space-x-2.5 bg-grey-100 dark:bg-grey-dark p-3 rounded-full px-4+1"
          >
            <span class="font-medium text-sm text-[#003b3d]">Create payroll</span>
            <span>
              <IArrowRightTail />
            </span>
          </button>
