...
const getProfile = async () => {
  ...
  if (successResponse && typeof successResponse !== "undefined") {
    ...
    data.value.group_id = successResponse.data.data.group ? successResponse.data.data.group.id : '---';
    ...
    if(responseData.value.data && responseData.value.data.data.payments.length){
